...
head(recordssorted)
data()
unique(records$CODES)
records
document()
?/names(census)

## to activate data docuemntation
#use_r("data")
...
library(genemaps)
devtools::load_all(".") # the current project
...
# Remerge with all sites info to incorporate information on those sites that did not report samples because they died orbecause of logistical problems
